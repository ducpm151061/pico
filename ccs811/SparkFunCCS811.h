...
public:
    ...
    CCS811_Status_e beginCore(i2c_inst_t* wirePort);
...
public:
    ...
    bool begin(i2c_inst_t* wirePort);                      //Use the Wire hardware by default
    CCS811_Status_e beginWithStatus(i2c_inst_t* wirePort); //Use the Wire hardware by default
