...
CCS811Core::CCS811_Status_e CCS811Core::beginCore(i2c_inst_t* wirePort)
{
...
CCS811Core::CCS811_Status_e CCS811Core::readRegister(uint8_t offset, uint8_t *outputPointer)
{
    ...
    i2c_write_blocking(_i2cPort, CCS811_ADDR, &offset, 1, true);

    // _i2cPort->beginTransmission(CCS811_ADDR);
    // _i2cPort->write(offset);
    // if (_i2cPort->endTransmission() != 0)
    // {
    // 	returnError = CCS811_Stat_I2C_ERROR;
    // }
    // _i2cPort->requestFrom(CCS811_ADDR, numBytes);
    // *outputPointer = _i2cPort->read(); // receive a byte as a proper uint8_t

    i2c_read_blocking(_i2cPort, CCS811_ADDR, outputPointer, numBytes, false);
    return returnError;
}
...
CCS811Core::CCS811_Status_e CCS811Core::multiReadRegister(uint8_t offset, uint8_t *outputPointer, uint8_t length)
{
    ...
    //     _i2cPort->requestFrom(CCS811_ADDR, length);
    ...
    // }
    i2c_write_blocking(_i2cPort, CCS811_ADDR, &offset, 1, true);
    i2c_read_blocking(_i2cPort, CCS811_ADDR, outputPointer, length, false);
...
CCS811Core::CCS811_Status_e CCS811Core::writeRegister(uint8_t offset, uint8_t dataToWrite)
{
    ...
    //     returnError = CCS811_Stat_I2C_ERROR;
    // }
    i2c_write_blocking(_i2cPort, CCS811_ADDR, &offset, 1, false);
    i2c_write_blocking(_i2cPort, CCS811_ADDR, &dataToWrite, 1, false);
...
CCS811Core::CCS811_Status_e CCS811Core::multiWriteRegister(uint8_t offset, uint8_t *inputPointer, uint8_t length)
{
    ...
    //     returnError = CCS811_Stat_I2C_ERROR;
    // }
    i2c_write_blocking(_i2cPort, CCS811_ADDR, &offset, length, false);
    i2c_write_blocking(_i2cPort, CCS811_ADDR, inputPointer, length, false);
    return returnError;
}
...
//
//****************************************************************************//
bool CCS811::begin(i2c_inst_t* wirePort)
{
...
//
//****************************************************************************//
CCS811Core::CCS811_Status_e CCS811::beginWithStatus(i2c_inst_t* wirePort)
{
    ...
    // }
    uint8_t css811_app_start = CSS811_APP_START;
    i2c_write_blocking(_i2cPort, CCS811_ADDR, &css811_app_start, 0, true);
